...
IF ERRORLEVEL 1 (
    ...
    IF ERRORLEVEL 1 (
        ...
        IF ERRORLEVEL 1 (
            "C:\Program Files (x86)\Microsoft Visual Studio\2019\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake" --help >nul 2>&1
            IF ERRORLEVEL 1 (
                "C:\Program Files\Microsoft Visual Studio\2019\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake" --help >nul 2>&1
                IF ERRORLEVEL 1 (
                    ...
                    "C:\Program Files\Microsoft Visual Studio\2019\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake" -A Win32 .
                )
            ) else (
                "C:\Program Files (x86)\Microsoft Visual Studio\2019\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake" -A Win32 .
            )
        ) else (
